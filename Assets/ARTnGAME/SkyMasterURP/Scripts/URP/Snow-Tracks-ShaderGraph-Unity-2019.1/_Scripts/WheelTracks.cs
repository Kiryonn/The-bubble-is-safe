...
public class WheelTracks : MonoBehaviour
{
    ...
    public RenderTexture _splatmapRT;
    ...
    private void Awake()
    {
        ...
        _splatmapRT = new RenderTexture (2048, 2048,0, RenderTextureFormat.ARGBFloat, RenderTextureReadWrite.Linear);
    ...
    void Update()
    {
        Graphics.Blit(_splatmap, _splatmapRT);
        _drawMaterial.SetTexture("_SplatMap", _splatmapRT);
        _snowMaterial.SetTexture("_SplatMap", _splatmapRT);
    }
    ...
    IEnumerator DrawEachWheel()
    {
        ...
        _splatmap.Update();
       // Debug.Log("Update tex with " + new Vector4(_groundHit.textureCoord.x, _groundHit.textureCoord.y, 0, 0));
