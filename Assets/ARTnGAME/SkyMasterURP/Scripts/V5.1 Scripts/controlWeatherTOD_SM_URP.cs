...
namespace Artngame.SKYMASTER
{
    ...
    public class controlWeatherTOD_SM_URP : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                volumeLightPower = etherealVolFog.blendVolumeLighting * 10;//v5.4.2
            }
            if (activateGUI && enableGUI && Application.isPlaying)
            {
                //etherealVolFog.blendVolumeLighting = 0.3f;
                volumeLightPower = etherealVolFog.blendVolumeLighting;////2;

                // Debug.Log("etherealVolFog.blendVolumeLighting = " + etherealVolFog.blendVolumeLighting);
        ...
        public void setFullVolumeCloudsDensityA(float density, float darkness, bool lerp)
        {
            if (lerp)
            {
                ...
                fullVolumeClouds._NoiseBias = Mathf.Lerp(fullVolumeClouds._NoiseBias, darkness + densityThicknessOffset, cloudTransitionSpeed * Time.deltaTime * 0.05f);
            }
            else
            {
                ...
                fullVolumeClouds._NoiseBias = darkness + densityThicknessOffset;
            }
        }
        ...
        public float volumeLightPower = 0.3f;
        public float volumeFogPower = 1;
        public float volumeFogNoise = 0;
