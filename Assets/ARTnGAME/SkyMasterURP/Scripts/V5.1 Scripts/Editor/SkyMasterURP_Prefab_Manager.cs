...
namespace Artngame.SKYMASTER {
    public class SkyMasterURP_Prefab_Manager : EditorWindow {

        // Prefabs are named by category and description is separated by "-". e.g. CAT_A - DecalA. 

        [MenuItem("Window/ARTnGAME/Sky Master URP/Sky Manager")]
        public static void ShowWindow() {

            //Debug.Log("SHOW");

            SkyMasterURP_Prefab_Manager TEM_Wizard = GetWindow<SkyMasterURP_Prefab_Manager>(true);
            //TEM_Wizard.title = "PDM 2.0";
            TEM_Wizard.titleContent.text = "Sky Manager";
            TEM_Wizard.Show();
        ...
        public string Prefab_Path = "Assets/ARTnGAME/SkyMasterURP/PREFABS/URP/Wizard/";////
        ...
        void Draw_Icons() {
            ...
            Category_Icons.Add(AssetDatabase.LoadAssetAtPath(Prefab_Path + "Icons/PDM20_CAT_1.png", typeof(Texture2D)) as Texture2D);
            Category_Icons.Add(AssetDatabase.LoadAssetAtPath(Prefab_Path + "Icons/PDM20_CAT_2.png", typeof(Texture2D)) as Texture2D);
            Category_Icons.Add(AssetDatabase.LoadAssetAtPath(Prefab_Path + "Icons/PDM20_CAT_3.png", typeof(Texture2D)) as Texture2D);
            Category_Icons.Add(AssetDatabase.LoadAssetAtPath(Prefab_Path + "Icons/PDM20_CAT_4.png", typeof(Texture2D)) as Texture2D);
            Category_Icons.Add(AssetDatabase.LoadAssetAtPath(Prefab_Path + "Icons/PDM20_CAT_5.png", typeof(Texture2D)) as Texture2D);
            Category_Icons.Add(AssetDatabase.LoadAssetAtPath(Prefab_Path + "Icons/PDM20_CAT_6.png", typeof(Texture2D)) as Texture2D);
            Category_Icons.Add(AssetDatabase.LoadAssetAtPath(Prefab_Path + "Icons/PDM20_CAT_7.png", typeof(Texture2D)) as Texture2D);
            Category_Icons.Add(AssetDatabase.LoadAssetAtPath(Prefab_Path + "Icons/PDM20_CAT_8.png", typeof(Texture2D)) as Texture2D);
            Category_Icons.Add(AssetDatabase.LoadAssetAtPath(Prefab_Path + "Icons/PDM20_CAT_9.png", typeof(Texture2D)) as Texture2D);
            Category_Icons.Add(AssetDatabase.LoadAssetAtPath(Prefab_Path + "Icons/PDM20_CAT_10.png", typeof(Texture2D)) as Texture2D);
            ...
            //string[] Prefabs_ALL = Directory.GetFiles(Prefab_Path, "*.prefab", SearchOption.AllDirectories);

            for (int i = 0; i < Prefabs_ALL.Length; i++) {
                Prefabs_names.Add(Prefabs_ALL[i].Replace(Prefab_Path + "Prefabs/", "").Replace('\\', '/').Replace(".prefab", ""));
                //Prefabs_names.Add(Prefabs_ALL[i].Replace(Prefab_Path, "").Replace('\\', '/').Replace(".prefab", ""));
            }
        ...
        void OnGUI() {
            ...
            if (GUILayout.Button(new GUIContent(props_state + " Props Library", props_state + " Props Library"), GUILayout.Width(190), GUILayout.Height(18)))
            {
                if (props_folder)
                {
                    props_folder = false;
            ...
            if (props_folder)
            {
                ...
                if (Camera.main != null)
                {
                    connectSuntoFullVolumeCloudsURP clouds = Camera.main.GetComponent<connectSuntoFullVolumeCloudsURP>();
                    if (clouds != null)
                    {
                        clouds.coverage = EditorGUILayout.Slider(clouds.coverage, 0, 10);
            ...
            if (library_folder) {
                ...
                GUI.TextField(new Rect(X_offset_left, 5 + Y_offset_top, 80, CATEGORIES_Y), "Base Clouds");
                ...
                category_counter += 1;
                GUI.TextField(new Rect(X_offset_left + CATEGORIES_X_STEP * category_counter, 5 + Y_offset_top, 80, CATEGORIES_Y), "Planetary Clouds");
                ...
                GUI.TextField(new Rect(X_offset_left + CATEGORIES_X_STEP * category_counter, 5 + Y_offset_top, 80, CATEGORIES_Y), "Biomes");
                ...
                GUI.TextField(new Rect(X_offset_left + CATEGORIES_X_STEP * category_counter, 5 + Y_offset_top, 80, CATEGORIES_Y), "Shader Clouds");
                ...
                GUI.TextField(new Rect(X_offset_left + CATEGORIES_X_STEP * category_counter, 5 + Y_offset_top, 80, CATEGORIES_Y), "Mobile");
                ...
                GUI.TextField(new Rect(X_offset_left + CATEGORIES_X_STEP * category_counter, 5 + Y_offset_top, 80, CATEGORIES_Y), "Particle Clouds");
                ...
                GUI.TextField(new Rect(X_offset_left + CATEGORIES_X_STEP * category_counter, 5 + Y_offset_top, 80, CATEGORIES_Y), "Special FX");
                ...
                GUI.TextField(new Rect(X_offset_left + CATEGORIES_X_STEP * category_counter, 5 + Y_offset_top, 80, CATEGORIES_Y), "Map Reset");
                ...
                GUI.TextField(new Rect(X_offset_left + CATEGORIES_X_STEP * category_counter, 5 + Y_offset_top, 80, CATEGORIES_Y), "Fog of War");
                ...
                GUI.TextField(new Rect(X_offset_left + CATEGORIES_X_STEP * category_counter, 5 + Y_offset_top, 80, CATEGORIES_Y), "Cloud Fluids");
                                        ...
                                        if (!Preview_mode) {
                                            if (!Copy_properties_mode) {
                                                if (!Add_to_selection) {
                                                    ...
                                                    //v0.1
                                                    GameObject SPHERE = (GameObject)PrefabUtility.InstantiatePrefab(Loaded_prefab_item);
