...
namespace Artngame.SKYMASTER.UnityEditor
{
    ...
    public class ShurikenMaster
    {
        ...
        static void SetupMaterialBlendStates(Material mat, BlendOp blendop, UnityEngine.Rendering.BlendMode src, UnityEngine.Rendering.BlendMode dst, bool blend, bool dither)
        {
        ...
        public static void SetupMaterialWithBlendMode(Material material, ShurikenMaster.ShaderBlendMode blendMode)
        {
            switch (blendMode)
            {
                case ShurikenMaster.ShaderBlendMode.Cutout:
                    SetupMaterialBlendStates(material, BlendOp.Add, UnityEngine.Rendering.BlendMode.One, UnityEngine.Rendering.BlendMode.Zero, false, false);
                    break;
                case ShurikenMaster.ShaderBlendMode.Additive:
                    SetupMaterialBlendStates(material, BlendOp.Add, UnityEngine.Rendering.BlendMode.SrcAlpha, UnityEngine.Rendering.BlendMode.One, true, false);
                    break;
                case ShurikenMaster.ShaderBlendMode.AlphaBlend:
                    SetupMaterialBlendStates(material, BlendOp.Add, UnityEngine.Rendering.BlendMode.SrcAlpha, UnityEngine.Rendering.BlendMode.OneMinusSrcAlpha, true, false);
                    break;
                case ShurikenMaster.ShaderBlendMode.PremultipliedAlpha:
                    SetupMaterialBlendStates(material, BlendOp.Add, UnityEngine.Rendering.BlendMode.One, UnityEngine.Rendering.BlendMode.OneMinusSrcAlpha, true, false);
                    break;
                case ShurikenMaster.ShaderBlendMode.Dithered:
                    SetupMaterialBlendStates(material, BlendOp.Add, UnityEngine.Rendering.BlendMode.One, UnityEngine.Rendering.BlendMode.Zero, false, true);
                    break;
                case ShurikenMaster.ShaderBlendMode.Modulate:
                    SetupMaterialBlendStates(material, BlendOp.Multiply, UnityEngine.Rendering.BlendMode.DstColor, UnityEngine.Rendering.BlendMode.OneMinusSrcAlpha, true, false);
                    break;
            }
        }
