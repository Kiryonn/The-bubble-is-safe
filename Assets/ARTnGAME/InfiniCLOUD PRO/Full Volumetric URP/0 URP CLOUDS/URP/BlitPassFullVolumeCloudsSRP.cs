    ...
    internal class BlitPassFullVolumeCloudsSRP : UnityEngine.Rendering.Universal.ScriptableRenderPass
    {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            if (Camera.main != null)
            {
                ...
                if (Camera.main != null && (cameraData.camera != Camera.main && !isForReflections))
                {
                    return;
                }
                desc.msaaSamples = 1;
                ...
                connector = cameraData.camera.GetComponent<connectSuntoFullVolumeCloudsURP>();
                ...
                if (connector == null)
                {
                    ...
                    {
                        connector = Camera.main.GetComponent<connectSuntoFullVolumeCloudsURP>();
                    }
                }
                ...
                if (inheritFromController && connector != null)
                {
                    ...
                    //v0.9
                    cameraWSOffset = connector.cameraWSOffset;

                    //v0.8
                    maskTexture = connector.maskTexture;//v0.1.1
                    ...
                    playerPos = connector.playerPos;
                    fogOfWarPower = connector.fogOfWarPower;
                    maskScale = connector.maskScale;//v0.1.1
                    maskScaleYRatio = connector.maskScaleYRatio;//v24d

                    topDownMaskCamera = connector.topDownMaskCamera;
                    fogOfWarRadius = connector.fogOfWarRadius;
                    fogOfWarColor = connector.fogOfWarColor; //v0.9
                    ...
                    //Beta 24d
                    WeatherTextureRT = connector.WeatherTextureRT;
                    ...
                    sunRaysPower = connector.sunRaysPower; //v1.3
                    ...
                    debugNoLowFreqNoise = connector.enableVORTEX;// debugNoLowFreqNoise = connector.debugNoLowFreqNoise;
                                                                 //v0.7
                    vortexPosition = connector.vortexPosition;
                    vortexRadius = connector.vortexRadius;
                    vortexControls = connector.vortexControls;
                    debugNoHighFreqNoise = connector.debugNoHighFreqNoise;
                    debugNoCurlNoise = connector.enableShadowCastOnClouds;//.debugNoCurlNoise; //v1.2 Beta 24
                    shadowPower = connector.shadowPower;//v1.3

                    //v1.2 Beta 24
                    superCellControls = connector.superCellControls;
                ...
                if (connectorFound && connector.enableFog && (cameraData.camera == Camera.main || isForReflections))// || isForDualCameras))
                {
                    //Debug.Log("IN1");
                    ...
                    //{
                       // Debug.Log("IN0");
                        ...
                        CloudMaterial.SetVector("_maskScale", new Vector2(maskScale, maskScale * maskScaleYRatio)); // CloudMaterial.SetFloat("_maskScale", maskScale);//v0.1.1 //v24d
                        ...
                        //v0.9
                        CloudMaterial.SetColor("fogOfWarColor", fogOfWarColor);
                        ...
                        CloudMaterial.SetVector("_CameraWS", cameraPos + cameraWSOffset); //Debug.Log("cameraPos:" + cameraPos);        //v0.9
                        ...
                        CloudMaterial.SetFloat("sunRaysPower", sunRaysPower);//v1.3
                    ...
                    //BLIT BACK
                    //using (var builder = renderGraph.AddRasterRenderPass<PassData>("BLIT BACK", out var passData, m_ProfilingSampler))
                    //{
                    //    passData.BlitMaterial = m_BlitMaterial;
                    //    // Similar to the previous pass, however now we set destination texture as input and source as output.
                    //    passData.src = builder.UseTexture(sourceTexture, IBaseRenderGraphBuilder.AccessFlags.Read);
            ...
            //      RenderTexture rtClouds = RenderTexture.GetTemporary((int)(rtW / ((float)downSample)), (int)(rtH / ((float)downSample)), 0, format);
                    ...
                    cmd.Blit(destination, rtClouds, CloudMaterial, 10);
#else
                    cmd.Blit(destination.id, rtClouds, CloudMaterial, 10);
#endif
                    */
                    ...
                    //Beta 24d
                    if (WeatherTextureRT != null)
                    {
                        CloudMaterial.SetTexture("_WeatherTexture", WeatherTextureRT);
                    }
                    else
                    {
                    ...
                    passName = "Render Clouds";
                        using (var builder = renderGraph.AddRasterRenderPass<PassData>(passName, out var passData))
                        {
                            ...
                            passData.BlitMaterial = m_BlitMaterial;
                            builder.SetRenderFunc((PassData data, RasterGraphContext context) =>
                                ExecuteBlitPass(data, context, 10, tmpBuffer1A));
                        }
                    ...
                    //    builder.UseTexture(WeatherTextureRT, IBaseRenderGraphBuilder.AccessFlags.Read);
                    //    builder.UseTexture(_cloudShapeTexture, IBaseRenderGraphBuilder.AccessFlags.Read);
                    ...
                    //        ExecuteBlitPassTEX9NAME(data, context, 10,
                    //        "_MainTex", tmpBuffer1A,
                    //        "_InteractTexture", _InteractTexture,
                    //        "_maskTexture", maskTexture,
                    //        "_WeatherTexture", WeatherTextureRT,
                    //        "_ShapeTexture", _cloudShapeTexture,
                    //        "_DetailTexture", _cloudDetailTexture,
                    //        "_CurlNoise", curlNoise,
                    //        "_BlueNoise", blueNoiseTexture,
                    //        "_AltoClouds", cloudsHighTexture
                    //        ));
                    //}
                    ...
                    Matrix4x4 camToWorld = Camera.main.cameraToWorldMatrix;
                        ...
                        if (enabledTemporalAA && Time.fixedTime > 0.05f)
                        {
                            ...
                            using (var builder = renderGraph.AddRasterRenderPass<PassData>(passName, out var passData))
                            {
                                ...
                                //builder.UseTextureFragmSetRenderAttachmentent(tmpBuffer3A, 0, AccessFlags.Write);
                                ...
                                builder.SetRenderFunc((PassData data, RasterGraphContext context) =>
                                    //ExecuteBlitPassTHREE(data, context, 19, tmpBuffer3A, previousFrameTextureA, previousDepthTextureA));
                                    ExecuteBlitPassTEN(data, context, 12, tmpBuffer2A, previousFrameTextureA, previousDepthTextureA,
                        ...
                        //                 cmd.Blit(tmpBuffer1, source, CloudMaterial, 11); //v0.1  
                    ...
                    using (var builder = renderGraph.AddRasterRenderPass<PassData>(passName, out var passData))
                    {
                        ...
                        passData.BlitMaterial = m_BlitMaterial;
                        builder.SetRenderFunc((PassData data, RasterGraphContext context) =>
                            ExecuteBlitPassTWO(data, context, 16, tmpBuffer1A, tmpBuffer2A));
                    }
        ...
        static void ExecuteBlitPassTWO(PassData data, RasterGraphContext context, int pass, TextureHandle tmpBuffer1, TextureHandle tmpBuffer2)
        {
            ...
            data.BlitMaterial.SetTexture("_CloudTex", tmpBuffer2);
            Blitter.BlitTexture(context.cmd, data.src, new Vector4(1, 1, 0, 0), data.BlitMaterial, pass);
        }
        ...
        {
            Blitter.BlitTexture(rgContext.cmd, data.src, new Vector4(1, 1, 0, 0), data.BlitMaterial, 14);
        }
        //private Material m_BlitMaterial;
        ...
        RTHandle _handle;
              ...
              //v0.5a
                ...
                //RTHandle _handleA;
                RTHandle _handleA; RTHandle _handleB; RTHandle _handleC; RTHandle _handleD;
#endif

#else
        UnityEngine.Rendering.Universal.RenderTargetHandle _handle; //v0.1 //RenderTargetHandle _handle;
#endif
        ...
        //v0.9
        public Vector3 cameraWSOffset = new Vector3(0, 0, 0);
        ...
        public float maskScaleYRatio = 1f;//24d
        ...
        public Color fogOfWarColor = new Color(0, 0, 0, 0); //v0.9
        ...
        //Beta 24d
        public RenderTexture WeatherTextureRT; //if this exists, use this instead of the below
        ...
        public float sunRaysPower = 1; //v1.3
        ...
        public Vector4 vortexControls = new Vector4(1, 1, 1, 1);//X,Y=rotation speed, W=!=1 typhoon intensity
                ...
                if (connector == null && Camera.main != null)
                {
                    ...
                    if(connector == null)
                    {
                        try
                        {
                            ...
                            if (effects != null)
                            {
                                connector = effects.GetComponent<connectSuntoFullVolumeCloudsURP>();
                            }
                        }
                        catch
                        {
     ...
     //           isForReflections = connector.isForReflections;
        ...
        ////// END VOLUME CLOUDS
            ...
            if (enableFog && connectorFound && (renderingData.cameraData.camera == Camera.main || isForReflections) && sunLight != null) //v0.1
            {
                CommandBuffer cmd = CommandBufferPool.Get(m_ProfilerTag);
        ...
        public override void FrameCleanup(CommandBuffer cmd)
        {
            //if (destination == renderingData.cameraData.renderer.cameraColorTargetHandle)// UnityEngine.Rendering.Universal.RenderTargetHandle.CameraTarget) //v0.1
            //{
            //    cmd.ReleaseTemporaryRT(Shader.PropertyToID(m_TemporaryColorTexture.name));//m_TemporaryColorTexture.id);            
            //    cmd.ReleaseTemporaryRT(Shader.PropertyToID(lrDepthBuffer.name));//lrDepthBuffer.id);               
            //}
        }    
	    ...
	    //v0.1
            cmd.GetTemporaryRT(Shader.PropertyToID(lrDepthBuffer.name), opaqueDesc, filterMode);//  lrDepthBuffer.id, opaqueDesc, filterMode);
            ...
            {               
                ...
                //Blit(cmd, source, lrDepthBuffer, sheetSHAFTS, 3);            
            ...
            {               
            	cmd.Blit(source, lrDepthBuffer, sheetSHAFTS, 2);//.Identifier(), sheetSHAFTS, 2);//v0.1
                //Blit(cmd, source, lrDepthBuffer, sheetSHAFTS, 2);//.Identifier(), sheetSHAFTS, 2);//v0.1
            }            

	     cmd.Blit(source,m_TemporaryColorTexture); 
            //Blit(cmd, source,m_TemporaryColorTexture); // m_TemporaryColorTexture.Identifier()); //KEEP BACKGROUND //v0.1
            ...
            //Blit(cmd, m_TemporaryColorTexture, source, sheetSHAFTS, (screenBlendMode == BlitFullVolumeCloudsSRP.BlitSettings.ShaftsScreenBlendMode.Screen) ? 0 : 4);
             cmd.Blit( m_TemporaryColorTexture, source, sheetSHAFTS, (screenBlendMode == BlitFullVolumeCloudsSRP.BlitSettings.ShaftsScreenBlendMode.Screen) ? 0 : 4);
       ...
       // public int resolution = 256;
        ...
        //public override void Render(PostProcessRenderContext context)
        {
            ...
            // Blit(cmd, destination, rtClouds, CloudMaterial, 10);
            ...
            //Blit(cmd, Shader.PropertyToID(destination.name), rtClouds, CloudMaterial, 10);
            ...
            if (enabledTemporalAA && Time.fixedTime > 0.05f && !isForReflections)
            {
            ...
            CloudMaterial.SetTexture("_MainTex", tmpBuffer1);
            //CloudMaterial.SetTexture("_CloudTexP", tmpBuffer1);
            CloudMaterial.SetTexture("_CloudTex", rtClouds);
        ...
        //public override void Render(PostProcessRenderContext context)
        {
            ...
            _material.SetVector("_CameraWS", camPos + cameraWSOffset); //v0.9
            ...
            if (isForReflections)
            {                
                _material.SetVector("_WorldSpaceCameraPosC", camPos + cameraWSOffset); //v0.9
            }
            else
            {
                _material.SetVector("_WorldSpaceCameraPosC", camPos + cameraWSOffset); //v0.9
                    ...
                    if (tmpBuffer == null)
                    {
						...
						if (blendBackground) { //v2.1.20
                            ...
                            if (isForReflections)
                            {
                                ...
                                cmd.Blit(backgroundCam.targetTexture, tmpBuffer); //URP //v0.1
                            }
                            else
                            {
                                backgroundCam.Render(); //TO FIX
                                //Graphics.Blit(backgroundCam.targetTexture, tmpBuffer, backgroundMat);
                                cmd.Blit( backgroundCam.targetTexture, tmpBuffer, backgroundMat); //URP//v0.1
                            }
						}
                        ...
                        else
                        {
                            ...
                            { //v2.1.20
                                ...
                                if (isForReflections)
                                {
                                    ...
                                    tmpBuffer.DiscardContents();//v4.1f
                                    //Graphics.Blit(backgroundCam.targetTexture, tmpBuffer);
                                    cmd.Blit( backgroundCam.targetTexture, tmpBuffer);//v0.1
                                }
                                else
                                {
                                    backgroundCam.Render();
                                    tmpBuffer.DiscardContents();//v4.1f
                                    //Graphics.Blit(backgroundCam.targetTexture, tmpBuffer, backgroundMat);
                                    cmd.Blit( backgroundCam.targetTexture, tmpBuffer, backgroundMat);//v0.1
                                }
                            }
        ...
        void renderMe(Camera cam, Material _material, RenderTextureDescriptor opaqueDesc, ScriptableRenderContext context, CommandBuffer cmd)
        {
            ...
            cmd.Blit( source, tmpBuffer1); //KEEP BACKGROUND //v0.1
            ...
            cmd.Blit( tmpBuffer1, source, _material, 6);//v0.1
...
#if UNITY_2022_1_OR_NEWER
        void CustomGraphicsBlitOpt(ScriptableRenderContext context, RenderTargetIdentifier source, RTHandle dest, RenderTexture skysource, Material fxMaterial, int passNr, Gradient DistGradient,
        ...
        {
#else
        void CustomGraphicsBlitOpt(ScriptableRenderContext context, RenderTargetIdentifier source, RenderTargetHandle dest, RenderTexture skysource, Material fxMaterial, int passNr, Gradient DistGradient,
                    Vector2 GradientBounds, Texture2D colourPalette, Camera cam, bool toggle, bool splitPerFrame, bool WebGL, CommandBuffer cmd, RenderTextureDescriptor opaqueDesc)
        {
#endif
            ...
            if (toggle)
            {
                ...
                cmd.Blit(source,new1,fxMaterial,6); //v0.1
                ...
                cmd.Blit(new1, _cloudBuffer); //URP //v0.1
                //release
              ...
              //  RenderTexture.active = tmpBuffer2;
                ...
                if (splitPerFrame && cameraMotionCompensate)
                {
                  //  fxMaterial.SetPass(8); //4
                    cmd.Blit( source, tmpBuffer2, fxMaterial, 8);  //v0.1
                }
                else
                {
                    //fxMaterial.SetPass(7);//3
                    cmd.Blit( source, tmpBuffer2, fxMaterial, 7);  //v0.1
                }

                cmd.Blit( tmpBuffer2, source);  //v0.1
                context.ExecuteCommandBuffer(cmd);
                CommandBufferPool.Release(cmd);
