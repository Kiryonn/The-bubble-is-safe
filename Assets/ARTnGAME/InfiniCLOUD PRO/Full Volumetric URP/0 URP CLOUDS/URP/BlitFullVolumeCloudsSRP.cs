...
{
    public class BlitFullVolumeCloudsSRP : UnityEngine.Rendering.Universal.ScriptableRendererFeature
    {
        [System.Serializable]
        public class BlitSettings
        {
            ...
            public UnityEngine.Rendering.Universal.RenderPassEvent Event = UnityEngine.Rendering.Universal.RenderPassEvent.AfterRenderingSkybox;
        ...
        BlitPassFullVolumeCloudsSRP blitPass;

        connectSuntoFullVolumeCloudsURP connector;//v0.4a
        ...
        public override void Create()
        {
            ...
            blitPass = new BlitPassFullVolumeCloudsSRP(settings.Event, settings.blitMaterial, settings.blitMaterialPassIndex, name, settings);
