...
namespace UnityEngine.Rendering.Universal
{
    ...
    /// </summary>
    internal class BlitPassVolumeCloudsSRP : UnityEngine.Rendering.Universal.ScriptableRenderPass
    {

        //v0.4  - Unity 2020.1
#if UNITY_2020_2_OR_NEWER
        public BlitVolumeCloudsSRP.BlitSettings settings;
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref UnityEngine.Rendering.Universal.RenderingData renderingData)
        {
            ...
            destination = (settings.destination == BlitVolumeCloudsSRP.Target.Color)
        ...
        //SUN SHAFTS         
        public BlitVolumeCloudsSRP.BlitSettings.SunShaftsResolution resolution = BlitVolumeCloudsSRP.BlitSettings.SunShaftsResolution.Normal;
        ...
        /// </summary>
        public BlitPassVolumeCloudsSRP(UnityEngine.Rendering.Universal.RenderPassEvent renderPassEvent, Material blitMaterial, int blitShaderPassIndex, string tag, BlitVolumeCloudsSRP.BlitSettings settings)
        {
        ...
        connectSuntoVolumeCloudsURP connector;
        ...
        public override void Execute(ScriptableRenderContext context, ref UnityEngine.Rendering.Universal.RenderingData renderingData)
        {
            ...
            connector = renderingData.cameraData.camera.GetComponent<connectSuntoVolumeCloudsURP>();
            ...
            if (connector == null)
            {
                connector = renderingData.cameraData.camera.gameObject.GetComponent<connectSuntoVolumeCloudsURP>();

                if (connector == null && Camera.main != null)
                {
                    connector = Camera.main.GetComponent<connectSuntoVolumeCloudsURP>(); //v0.1
                    ...
                    if (connector == null)
                    {
                        try
                        {
                            ...
                            if (effects != null)
                            {
                                connector = effects.GetComponent<connectSuntoVolumeCloudsURP>();
                            }
                        }
                        catch
                        { }
        ...
        public override void FrameCleanup(CommandBuffer cmd)
        {
            ...
            if (destination == UnityEngine.Rendering.Universal.RenderTargetHandle.CameraTarget)
            {
                ...
                cmd.ReleaseTemporaryRT(Shader.PropertyToID(lrDepthBuffer.name));
            }
#endif
        }
        ...
        public void RenderShafts(ScriptableRenderContext context, UnityEngine.Rendering.Universal.RenderingData renderingData, CommandBuffer cmd, RenderTextureDescriptor opaqueDesc)
        {
            ...
            //Blit(cmd, m_TemporaryColorTexture.Identifier(), source, sheetSHAFTS, (screenBlendMode == BlitVolumeCloudsSRP.BlitSettings.ShaftsScreenBlendMode.Screen) ? 0 : 4);
            cmd.Blit(m_TemporaryColorTexture, source, sheetSHAFTS, (screenBlendMode == BlitVolumeCloudsSRP.BlitSettings.ShaftsScreenBlendMode.Screen) ? 0 : 4);
