...
{
    public class BlitVolumeCloudsSRP : UnityEngine.Rendering.Universal.ScriptableRendererFeature
    {
        [System.Serializable]
        ...
        BlitPassVolumeCloudsSRP blitPass;
        ...
        public override void Create()
        {
            ...
            blitPass = new BlitPassVolumeCloudsSRP(settings.Event, settings.blitMaterial, settings.blitMaterialPassIndex, name, settings);
