...
namespace PlanetaryTerrain.Extra
{
    public class FPSController : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            targetVelocity.y = transform.InverseTransformDirection(m_rigidbody.linearVelocity).y;
            ...
            curVelocity = transform.InverseTransformDirection(m_rigidbody.linearVelocity);
            deltaV = transform.TransformDirection(targetVelocity - curVelocity);

            m_rigidbody.linearVelocity += deltaV;
