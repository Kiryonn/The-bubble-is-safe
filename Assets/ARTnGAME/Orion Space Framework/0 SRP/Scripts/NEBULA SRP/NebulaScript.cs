...
namespace Artngame.SKYMASTER
{
    ...
    [AddComponentMenu("Effects/Nebula")]
    public class NebulaScript : SceneViewFilter
    {
        public float backgroundOnly = 0; //Background only blend mode
        public Vector3 YCutHeightDepthScale = new Vector3(0,1,0);
        ...
        public Material CloudMaterial
        {
            get
            {
                if (!_CloudMaterial)
                {
                    _CloudMaterial = new Material(Shader.Find("Hidden/CloudsNebula"));
        ...
        public Material UpscaleMaterial
        {
            get
            {
                if (!_UpscaleMaterial)
                {
                    _UpscaleMaterial = new Material(Shader.Find("Hidden/NebulaBlender"));
        ...
        public void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            updateMaterialKeyword(enableVORTEX, "DEBUG_NO_LOW_FREQ_NOISE"); //v1.1.2
            ...
            UpscaleMaterial.SetFloat("backgroundOnly", backgroundOnly);
