...
{
    public class lightningCameraVolumeNebula_SRP : MonoBehaviour
    {
        ...
        public NebulaScript fullvolumeCloudsScript;//public connectSuntoFullVolumeCloudsURP fullvolumeCloudsScript;
