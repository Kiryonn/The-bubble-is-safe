...
//#else
		...
		float3x3 rotator = rotationMatrix(vortexAxis.xyz, vortexControlsA.x*_Time.y + ((2 * vortexControlsA.z) - vortexControlsA.y * 700 * (distanceToVortexCenter / 10000000)));
...
//#endif
		...
		depth *= _FarPlane * 100 * YCutHeightDepthScale.y;// *1; //v0.9 - v5.2.1 //depth *= _FarPlane *100;
