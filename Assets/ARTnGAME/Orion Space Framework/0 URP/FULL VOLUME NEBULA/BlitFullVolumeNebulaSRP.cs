...
{
    public class BlitFullVolumeNebulaSRP : UnityEngine.Rendering.Universal.ScriptableRendererFeature
    {
        [System.Serializable]
        ...
        public BlitFullVolumeNebulaSRP.BlitSettings settings = new BlitFullVolumeNebulaSRP.BlitSettings();
        RTHandle m_RenderTextureHandle;//UnityEngine.Rendering.Universal.RenderTargetHandle m_RenderTextureHandle; //v0.1

        BlitPassFullVolumeNebulaSRP blitPass;

        connectSuntoFullVolumeNebulaURP connector;//v0.4a
        ...
        public override void Create()
        {
            ...
            blitPass = new BlitPassFullVolumeNebulaSRP(settings.Event, settings.blitMaterial, settings.blitMaterialPassIndex, name, settings);
        ...
        public override void AddRenderPasses(UnityEngine.Rendering.Universal.ScriptableRenderer renderer, ref UnityEngine.Rendering.Universal.RenderingData renderingData)
        {
           ...
           // {
            ...
            //v0.4a
            if(connector != null && connector.renderAfterTransparent){
                    blitPass.renderPassEvent = UnityEngine.Rendering.Universal.RenderPassEvent.AfterRenderingTransparents;//BeforeRenderingTransparents;
                }
           ...
           //else
            ...
            if (connector != null && connector.renderAfterTransparent)
            {
                 blitPass.renderPassEvent = UnityEngine.Rendering.Universal.RenderPassEvent.AfterRenderingTransparents;
            }
