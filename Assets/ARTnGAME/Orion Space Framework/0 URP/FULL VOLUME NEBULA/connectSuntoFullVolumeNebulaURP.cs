...
{
    [ExecuteInEditMode]
    public class connectSuntoFullVolumeNebulaURP : MonoBehaviour
    {
        [Tooltip("Unity 2022 new Blitter, requires PATCH inside the Resources folder with the Nebula shader")]
        public bool Unity2022 = false; //requires PATCH inside the Resources folder with the Nebula shader
        ...
        public float cameraScale = 80; //use 80 for correct cloud scaling in relation to land
        public float extendFarPlaneAboveClouds = 1;

        public int cloudChoice = 1;
        ...
        public bool enableVORTEX = false;//debugNoLowFreqNoise = false;
        ...
        [Tooltip("Enable Stars and Galaxy system")] //v1.1.2
