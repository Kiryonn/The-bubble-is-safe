...
{
    public class BlitAtmosSRP : UnityEngine.Rendering.Universal.ScriptableRendererFeature
    {
        [System.Serializable]
        ...
        public override void Create()
        {
            ...
            blitPass = new BlitPassAtmosSRP(settings.Event, settings.blitMaterial, settings.blitMaterialPassIndex, name, settings);
