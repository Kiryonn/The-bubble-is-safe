...
namespace Artngame.LUMINA
{
    ...
    public class LUMINA : MonoBehaviour
    {
        ...
        void ResizeDummyTexture()
        {
            ...
            dummyVoxelTextureAAScaled = new RenderTexture(dummyVoxelResolution, dummyVoxelResolution, 16, RenderTextureFormat.R8);
            ...
            dummyVoxelTextureFixed = new RenderTexture((int)voxelResolution, (int)voxelResolution, 16, RenderTextureFormat.R8);
