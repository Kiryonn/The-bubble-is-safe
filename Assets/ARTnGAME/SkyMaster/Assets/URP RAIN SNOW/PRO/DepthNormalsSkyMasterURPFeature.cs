...
{
    public class DepthNormalsSkyMasterURPFeature : ScriptableRendererFeature
    {
        class DepthNormalsPass : ScriptableRenderPass
        {
            ...
            public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
            {
                ...
                descriptor.depthBufferBits = 64;// 32;
                descriptor.colorFormat = RenderTextureFormat.ARGB32;

                //cmd.GetTemporaryRT( Shader.PropertyToID(destination.name), descriptor, FilterMode.Point);
                cmd.GetTemporaryRT(Shader.PropertyToID(destination.name), descriptor, FilterMode.Bilinear);
